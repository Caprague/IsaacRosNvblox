...
constexpr Param<float>::Description kDistanceMapLocalMaintenance{
  "distance_map_local_maintenance", 4.0F,
  "The maintenance distance of local map."};  
...
constexpr Param<float>::Description kPublishLocomotionHeightScanRateHzParamDesc{
  "publish_locomotion_height_scan_rate_hz", 50.F,
  "The desired rate for publishing height scan messages - for locomotion policy."};
