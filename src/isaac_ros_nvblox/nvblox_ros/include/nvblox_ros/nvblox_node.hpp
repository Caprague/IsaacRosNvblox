...
protected:
  ...
  rclcpp::Time publish_navigation_height_scan_last_time_ = rclcpp::Time(0, 0, RCL_ROS_TIME);

  // Reader-writer mutex protecting TSDF layer access.
  // Height scan thread: shared_lock during sampling.
